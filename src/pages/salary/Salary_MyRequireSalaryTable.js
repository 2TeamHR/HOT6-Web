...
// /* 급여 정정 신청서 */
// export function RequireSalaryModal({onClose, certificate}) {
...
// export default function MyRequireSalaryTable({certificate}) {
...
//             ))}
//           </TableBody>
//               {/* {showModal && selectedCertificateInfo.eaCertCategory.certCategoryName === '재직증명서' && <RequireSalaryModal onClose={handleCloseModal} certificate={selectedCertificateInfo} /> } */}

import { Box, Chip, Collapse, IconButton, Step, StepLabel, Stepper, TableCell, TableRow, Typography } from "@mui/material";
        ...
        <>
            ...
            <TableRow>
                ...
                <TableCell align="center">
                    ...
                    {/* 모달 */}
                    <Suspense>  <EaModalNew documentInfo={docu} /></Suspense>

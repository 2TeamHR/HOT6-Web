          ...
          <Grid item xs={8}>
            <Paper elevation={5} >
              ...
              <Grid container columns={6}>
                ...
                <Grid item xs={3}><label>급여정정 날짜</label>
                </Grid><Grid item xs={3}><input type="date" name="" id="" /></Grid>
                <Grid item xs={3}><label>첨부파일</label></Grid>
                <Grid item xs={3}><input type="file" name="" id="" /></Grid>
              </Grid>

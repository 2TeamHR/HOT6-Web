import annualHistoryTableData from '../resources/data/annual_history_table_data.json';
...
export function getAnnualHistoryTableData() {
    ...
    return annualHistoryTableData;
}

export function getAnnualManagementTableData() {

    return annualManagementTableData;
}

export function getAnnualPaymentTableData() {

    return annualPaymentTableData;
}

export function getMypageAnnualHistoryTableData() {

    return mypageAnnualHistoryTableData;
}

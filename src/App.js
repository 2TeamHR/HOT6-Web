      ...
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          <Route path="/" element={<Layout />}>
            ...
            {/* 전자결재 */}
            <Route path="/ea/main" element={<EsMain />} />
            <Route path='/ea/draftMenu' element={<EsDraftMenu />}/>
            ...
            <Route path='/ea/draftInbox' element={<EsDraftInbox />}/>
            <Route path='/ea/wait' element={<EsWaitInbox />}/>
            <Route path='/ea/prograss' element={<EsPrograssInbox />}/>
            <Route path='/ea/complete' element={<EsCompleteInbox />}/>
